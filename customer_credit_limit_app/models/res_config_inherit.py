...
class ResConfigSettings(models.TransientModel):
    ...
    sale_approve = fields.Selection([('before','Approve Before Delivery Order'),('after','Approve After Delivery Order')],default='after',string="Sale Approve",related="company_id.sale_approve",readonly=False)
